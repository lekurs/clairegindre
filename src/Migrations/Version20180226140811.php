 ...
 */
class Version20180226140811 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user DROP benefit, DROP roles, DROP is_active');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user ADD benefit VARCHAR(50) DEFAULT NULL COLLATE utf8_unicode_ci, ADD roles VARCHAR(255) DEFAULT \'ROLE_USER\' NOT NULL COLLATE utf8_unicode_ci, ADD is_active TINYINT(1) NOT NULL');
    }
}
