 ...
 */
final class Version20180619084055 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clairegindre_picture (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', gallery_maker_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', gallery_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', picture_name VARCHAR(100) NOT NULL, public_path VARCHAR(255) NOT NULL, extension VARCHAR(5) NOT NULL, display_order INT DEFAULT NULL, favorite TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_956923515D578C78 (gallery_maker_id), INDEX IDX_956923514E7AF8F (gallery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
